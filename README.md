...
- `1- Update System` : Keep your repositories up to date.
- `2- Check Needed Upgrades` : See available upgrades for installed packages.
- `3- Upgrade System` : Perform system upgrades seamlessly.
